...
// 커버리지를 단계적으로 확대하며(#152 → #173) 상한도 0.95 → 0.8 → 0.5 로 낮춰
// 미검수(사전 정의문) 단서 비중을 강제로 제한한다. #173에서 발행 팩 7종을 모두
// 검수해 퍼즐당 미검수 비율을 0.44 이하로 낮춘 뒤 상한을 0.5 로 조정했다.
export const DEFAULT_MAX_NEEDS_MANUAL_CLUE_RATIO = 0.5;
