...
| 분석                  | AppsInToss Analytics, Firebase Analytics | 화면 진입, 힌트 사용, 광고 이벤트                                        |
...
날짜별 미션 상태, 퍼즐 진행 상태, 힌트 사용/보상 횟수는 사용자의 기기에 저장됩니다. 로그인, 결제, 서버 저장, 민감정보 수집은 사용하지 않습니다. 서비스 개선과 광고 QA를 위해 화면 진입, 힌트 사용, 광고 로드/보상 이벤트를 분석 도구로 기록합니다. 정답 후보는 공공/오픈 사전 데이터를 바탕으로 확인하고, 기존 신문, 앱, 블로그, 출판물의 퍼즐 문제나 격자를 복제하지 않습니다.
```
